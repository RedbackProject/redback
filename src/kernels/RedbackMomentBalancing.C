...
RedbackMomentBalancing::RedbackMomentBalancing(const InputParameters & parameters) :
    Kernel(parameters),
...
Real
RedbackMomentBalancing::computeQpResidual()
{
  Real the_sum = 0.0;
